...
<div class="card mt-3">
    <div class="card-header">
      <b>  Update Discount : {{$discount->name}} </b>
    </div>
    <div class="card-body">
        ...
        <div class="form-group mb-4"> 
            ...
            <input name="description" cols="0" rows="2" class="form-control {{$errors->has('description') ? 'is-invalid' : ''}}" value="{{old('description') ?: $discount->description}}" required/>
